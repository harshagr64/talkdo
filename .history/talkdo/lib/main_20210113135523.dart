        ...
        child: Stack(
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFF3716D1).withOpacity(0.9),
                    Color(0xFF120965).withOpacity(0.9),
                    // Color(0xFF29128A).withOpacity(1),
            ...
            Container(
              ...
              child: Image.asset('assets/images/home4.png', fit: BoxFit.cover),
            ),
            Center(
              child: Column(
