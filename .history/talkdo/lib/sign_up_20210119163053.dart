...
if(_c1.text.length == 0 || _c1.text.length == 0 || _c1.text.length == 0 || _c1.text.length == 0 || _c1.text.length == 0 || _c1.text.length == 0)
  ...
  Future<void> smsCodeDialoge(BuildContext context) {
    otpWidget();
  }
