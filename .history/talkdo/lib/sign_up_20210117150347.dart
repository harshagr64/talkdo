...
class _SignUpState extends State<SignUp> {
  ...
  Future<bool> _signUpUser(String phone) async {
    ...
    _auth.verifyPhoneNumber(phoneNumber: phone, verificationCompleted: null, verificationFailed: null, codeSent: null, codeAutoRetrievalTimeout: null)
  }
  ...
  steps() {
    ...
    if (step == 1) {
      if (_phone.text.length < 10 ||
          !_phone.text.contains(new RegExp(r'[0-9]'))) {
        setState(() {
          isValid = true;
        });
        return;
