            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  height: 60,
                  decoration: BoxDecoration(
                    color: Color(0xFF5F26C7).withOpacity(0.9),
                    borderRadius: BorderRadius.circular(30),
                    boxShadow: [
                      BoxShadow(
                        blurRadius: 7,
                        spreadRadius: 3,
                        offset: Offset(0, 3),
                        color: Color(0xFFC9A7FC).withOpacity(0.8),
                      ),
                    ],
                  ),
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Next',
                          style: myStyle(18, Color(0xFFFAF9FC).withOpacity(0.9),
                              FontWeight.w500, 0, 1),
                        ),
                        Stack(
                          alignment: Alignment.center,
                          children: [
                            Container(
                              ...
                              width: 40,
                              decoration: BoxDecoration(
                                color: Color(0xFFC9A7FC).withOpacity(0.4),
                                borderRadius: BorderRadius.circular(20),
                              ),
                            ),
                            IconButton(
