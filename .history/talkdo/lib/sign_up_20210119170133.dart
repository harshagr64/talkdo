...
class _SignUpState extends State<SignUp> {
  ...
  steps() {
    ...
    if (step == 1) {
      ...
      String otp = '${_c1.text}${_c2.text}${_c3.text}${_c4.text}${_c5.text}${_c6.text}';

      AuthCredential credential = PhoneAuthProvider.getCredential(verificationId: ver, smsCode: null)
